...
export async function POST(req: Request) {
  ...
  if (trigger === "submit-message") {
    ...
    const messageIndex = messageId == null ? messages.length - 1 : messages.findIndex((message) => message.id === messageId);
    ...
    messages = messages.slice(0, messages[messageIndex].role === "assistant" ? messageIndex : messageIndex + 1);
  }
